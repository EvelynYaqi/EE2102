...
\end{align}
\begin{enumerate}
\item As $U$ and $V$ are of same distribution, 
\begin{align}
E(U-V) = E(U) - E(V) = 0
\end{align}
Hence, the distribution of U-V is symmetric about 0.\\
Option 1 is correct.
\item As U and V are independent and identically distributed,
\begin{align}
E(U.V) &= E(U)\times E(V) \\
&= \frac{4}{\lambda^{2}}
\end{align}
...
\item When $X \sim Gamma(\alpha,\lambda)$,
\begin{align}
E(X) = \frac{\alpha}{\lambda}
\end{align}
...
Option 3 is correct.
\item From \eqref{eq:55_2023_4}, distribution of $\frac{U}{V}$ is symmetric about 2 (since it is its mean) and not 1.\\
