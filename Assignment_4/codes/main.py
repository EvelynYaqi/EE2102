...
C[0] = 3
C[1] = -5
#Vertices were generated using above code and for latex and gnumeric files, the following have been chosen:
#A = [-4  5]
#B = [-5 -6]
#C = [ 3 -5]
...
plt.grid() # minor
plt.axis('equal')
plt.savefig('/home/lancelot/Latex/EE2102/Assignment_4/figs/tri.png')
plt.show()
...
plt.grid() # minor
plt.axis('equal')
plt.savefig('/home/lancelot/Latex/EE2102/Assignment_4/figs/tri_median.png')
plt.show()
...
plt.grid() # minor
plt.axis('equal')
plt.savefig('/home/lancelot/Latex/EE2102/Assignment_4/figs/tri_alti.png')
plt.show()
...
plt.grid() # minor
plt.axis('equal')
plt.savefig('/home/lancelot/Latex/EE2102/Assignment_4/figs/tri_ang_bisec.png')
plt.show()
...
plt.grid() # minor
plt.axis('equal')
plt.savefig('/home/lancelot/Latex/EE2102/Assignment_4/figs/tri_perp_bisec.png')
plt.show()
