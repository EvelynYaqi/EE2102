...
\textbf{Solution :}\\
	...
	\end{align}
	Using the formula mentioned in the question to find out the angular bisector for sides \text{AB} and \text{AC}, naming the angular bisector $\vec{d}$ we get,\\
	\begin{align}
	...
	\end{align}
	Hence, the internal angluar bisector of angle \text{A},\\$\vec{d}$ will be,\\
	\begin{align}
		\myvec{\frac{7-\sqrt{37}}{\sqrt{74}}&\frac{5+\sqrt{37}}{\sqrt{74}}} \vec{x}=\frac{2-2\sqrt{37}}{\sqrt{74}}
	\end{align}
\end{document}
