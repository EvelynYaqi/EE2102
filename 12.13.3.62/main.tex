...
\begin{table}[htbp]
  ...
  \begin{tabular}{|c|c|c|}
    \hline
    Event & Random Variable & Description\\
   % \hline
   % Row 1 & Data 1 & Data 2 \\
    \hline
    \multirow{2}{*}{A} & 0 & \text{Event A doesn't happen} \\
    \cline{2-3}
    & 1 & \text{Event A happens} \\
    \hline
     \multirow{2}{*}{B} & 0 & \text{Event B doesn't happen} \\
    \cline{2-3}
    & 1 & \text{Event B happens} \\
    \hline
  \end{tabular}
  %\caption{A table with subrows.}
  %\label{tab:subrows}
\end{table}
