...
%\end{document}
	...
	\begin{table}[htbp]
	    ...
	    \begin{tabular}{|c|c|c|c|}
	        ...
	        \hline
	        A.B & Both Event A and B happen & $\frac{1}{6}$ \\ 
	        \hline
	    \end{tabular}
	\end{table}
\begin{enumerate}
	\item 
	\begin{align}
	\pr{\frac{A}{B}} &= \frac{1}{2}\label{eq:12_13_3_62_1}\\
	\pr{A}.\pr{B} &= \frac{1}{2}\times \frac{1}{3}\\
	&= \frac{1}{6}\label{eq:12_13_3_62_2}
	\end{align}
	As \eqref{eq:12_13_3_62_1} and \eqref{eq:12_13_3_62_2} are not equal, option 1 is not correct.
	\item
	\begin{align}
		\frac{\pr{A.B}}{\pr{B}} &= \frac{\frac{1}{6}}{\frac{1}{3}}\\
		&= \frac{1}{2}\label{eq:12_13_3_62_3}
	\end{align}
		As \eqref{eq:12_13_3_62_1} and \eqref{eq:12_13_3_62_3} are equal, option 2 is correct.
	\begin{align}
		\pr{\frac{A}{B}} &= \frac{\pr{A.B}}{\pr{B}}\label{eq:12_13_3_62_4}
	\end{align}
	\item
		From \eqref{eq:12_13_3_62_3},
	\begin{align}
		\pr{\frac{A}{B}}.\pr{\frac{B}{A}} &= \frac{\pr{A.B}}{\pr{B}} \times \frac{\pr{A.B}}{\pr{A}}\\
		&= \frac{{\pr{A.B}}^2}{\pr{A}.\pr{B}}\\
		&\ne 1
	\end{align}
		Hence, option 3 is incorrect. Let us verify it using the example.
		From \eqref{eq:12_13_3_62_3},
	\begin{align}
		\frac{{\pr{A.B}}^{2}}{\pr{A}.\pr{B}} &= \frac{{\frac{1}{6}}^2}{\frac{1}{2}\times \frac{1}{3}}\\
		&= \frac{1}{6}
	\end{align}
