...
plt.grid() # minor
plt.axis('equal')
plt.savefig('/home/lancelot/Latex/EE2102/Random vector/figs/figure1.png')
plt.show()
...
plt.grid() # minor
plt.axis('equal')
plt.savefig('/home/lancelot/Latex/EE2102/Random vector/figs/figure2.png')
plt.show()
...
plt.grid() # minor
plt.axis('equal')
plt.savefig('/home/lancelot/Latex/EE2102/Random vector/figs/figure3.png')
plt.show()
...
plt.grid() # minor
plt.axis('equal')
plt.savefig('/home/lancelot/Latex/EE2102/Random vector/figs/figure4.png')
plt.show()
